...
void StatusXmlCommand::Execute()
{
	const char* XML_STATUS_START =
		...
		"<member><name>SharingUser</name><value><string>%s</string></value></member>\n"
                "<member><name>SharingPollResume</name><value><boolean>%s</boolean></value></member>\n"
	...
	int queuedScripts = g_QueueScriptCoordinator->GetQueueSize();
        const char* sharingUser = g_WorkState->GetCurrentSharingUser();
        bool pollResume = g_WorkState->GetSharingPollResume();
	...
	AppendFmtResponse(IsJson() ? JSON_STATUS_START : XML_STATUS_START,
		...
		downloadRate, averageDownloadRate, downloadLimit, threadCount,
                          postJobCount, postJobCount, urlCount, upTimeSec, downloadTimeSec, sharingUser, BoolToStr(pollResume),
